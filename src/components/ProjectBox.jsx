export default function ProjectBox({ repo, imageSrc }) {
    ...
    return (
        <div 
            className="bg-white/5 border border-white/10 rounded-2xl shadow-lg p-4 w-full transition-transform duration-300 hover:scale-105 flex items-center gap-4"
        >
            <img
