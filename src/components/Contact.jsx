    ...
    return(
        <section id="contact" className="px-4 sm:px-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mb-8">
                <a href="mailto:ramoszaid5@gmail.com" target="_blank" className="transition-transform duration-300 hover:scale-110">
                    <img
                        src="https://upload.wikimedia.org/wikipedia/commons/4/4e/Gmail_Icon.png"
                        alt="Gmail"
                        className="inline-block w-14 h-14 rounded-full bg-white p-2 shadow-lg"
                    />
                </a>
                <a href="https://www.linkedin.com/in/rafaelpinones16/" target="_blank" className="transition-transform duration-300 hover:scale-110">
                    <img
                ...
                <a href="https://github.com/SaidPR/" target="_blank" className="transition-transform duration-300 hover:scale-110">
                    <img
