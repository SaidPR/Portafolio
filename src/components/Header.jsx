...
export default function Header() {
    ...
    return (
    <header id="about" className="px-4 sm:px-8 md:px-16 lg:px-32 mt-20 scroll-mt-30">
        ...
        <div className="text-center sm:text-left mt-4 sm:mt-0">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold animate-fade-in-left">¡Hola, soy Said Ramos!</h1>
          <p className="mt-4 text-sm sm:text-base md:text-lg animate-fade-in-left animate-delay-100 text-justify">
            Soy estudiante de Ingeniería en Sistemas Computacionales <br/> enfocado en el desarrollo web y desarrollo de software con <br/>
