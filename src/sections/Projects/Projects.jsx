...
export default function Projects() {
  return (
    <section id="projects" className="px-4 sm:px-8 lg:px-16 py-12 text-center scroll-mt-28">
      ...
      <div className="max-w-5xl mx-auto bg-gradient-to-br from-white/10 via-white/5 to-white/10 border border-white/10 rounded-3xl shadow-2xl backdrop-blur-lg overflow-hidden">
